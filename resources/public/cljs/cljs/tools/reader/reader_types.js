...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7876 = (function (reader){
...
return m__5374__auto__.call(null,reader);
} else {
var m__5372__auto__ = (cljs.tools.reader.reader_types.read_char["_"]);
if((!((m__5372__auto__ == null)))){
return m__5372__auto__.call(null,reader);
} else {
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7876.call(null,reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7888 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7888.call(null,reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7904 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
var m__5374__auto__ = (cljs.tools.reader.reader_types.unread[goog.typeOf(x__5373__auto__)]);
if((!((m__5374__auto__ == null)))){
return m__5374__auto__.call(null,reader,ch);
} else {
var m__5372__auto__ = (cljs.tools.reader.reader_types.unread["_"]);
if((!((m__5372__auto__ == null)))){
return m__5372__auto__.call(null,reader,ch);
} else {
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7904.call(null,reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7934 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7934.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7936 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7936.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7941 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7941.call(null,reader);
}
});
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.tools.reader.reader-types/StringReader");
}));
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.tools.reader.reader-types/NodeReadableReader");
}));
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.tools.reader.reader-types/PushbackReader");
}));
...
var self__ = this;
var reader__$1 = this;
var temp__5825__auto__ = cljs.tools.reader.reader_types.read_char.call(null,self__.rdr);
if(cljs.core.truth_(temp__5825__auto__)){
var ch = temp__5825__auto__;
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.tools.reader.reader-types/IndexingPushbackReader");
}));
...
var temp__5825__auto__ = new cljs.core.Keyword(null,"buffer","buffer",617295198).cljs$core$IFn$_invoke$arity$1(frames);
if(cljs.core.truth_(temp__5825__auto__)){
var buffer = temp__5825__auto__;
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.tools.reader.reader-types/SourceLoggingPushbackReader");
}));
...
var G__8036 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
var G__8037 = s.append(c);
c = G__8036;
s = G__8037;
continue;
}
