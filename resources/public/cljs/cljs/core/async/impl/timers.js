...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_10695 = (0);
while(true){
if((i_10695 < arr.length)){
(arr[i_10695] = null);

var G__10696 = (i_10695 + (1));
i_10695 = G__10696;
continue;
} else {
}
...
var i_10736 = (self__.level + (1));
while(true){
if((i_10736 <= (new_level + (1)))){
(update[i_10736] = self__.header);

var G__10742 = (i_10736 + (1));
i_10736 = G__10742;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_10743 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_10743[i]));
} else {
x__$2.forward.push((((i < links_10743.length))?(links_10743[i]):null));
}

if((i < links_10743.length)){
(links_10743[i] = x__$2);
} else {
links_10743.push(x__$2);
}
...
var i_10745 = (0);
while(true){
if((i_10745 <= self__.level)){
var links_10746 = (update[i_10745]).forward;
if((x__$1 === (((i_10745 < links_10746.length))?(links_10746[i_10745]):null))){
(links_10746[i_10745] = (x__$1.forward[i_10745]));

var G__10747 = (i_10745 + (1));
i_10745 = G__10747;
continue;
} else {
var G__10748 = (i_10745 + (1));
i_10745 = G__10748;
continue;
}
} else {
...
var G__10756 = nx;
var G__10757 = (level__$1 - (1));
x = G__10756;
level__$1 = G__10757;
continue;
} else {
var G__10758 = x;
var G__10759 = (level__$1 - (1));
x = G__10758;
level__$1 = G__10759;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__10767 = nx;
var G__10768 = (level__$1 - (1));
x = G__10767;
level__$1 = G__10768;
continue;
} else {
var G__10769 = x;
var G__10770 = (level__$1 - (1));
x = G__10769;
level__$1 = G__10770;
continue;
}
...
return cljs.core._write.call(null,writer__5311__auto__,"cljs.core.async.impl.timers/SkipList");
}));
