...
var vec__10716 = ((cljs.core.map_QMARK_.call(null,credentials))?cljs.core.map.call(null,credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.call(null,vec__10716,(0),null);
var password = cljs.core.nth.call(null,vec__10716,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__10721){
...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__10726 = (new goog.Uri());
G__10726.setScheme(cljs.core.name.call(null,(function (){var or__5025__auto__ = scheme;
...
G__10726.setDomain(server_name);

G__10726.setPort(server_port);

G__10726.setPath(uri);

G__10726.setQuery(query_string,true);
...
return cljs.core.reduce.call(null,(function (p1__10735_SHARP_,p2__10734_SHARP_){
var vec__10739 = clojure.string.split.call(null,p2__10734_SHARP_,/:\s+/);
var k = cljs.core.nth.call(null,vec__10739,(0),null);
var v = cljs.core.nth.call(null,vec__10739,(1),null);
if(((clojure.string.blank_QMARK_.call(null,k)) || (clojure.string.blank_QMARK_.call(null,v)))){
return p1__10735_SHARP_;
} else {
return cljs.core.assoc.call(null,p1__10735_SHARP_,clojure.string.lower_case.call(null,k),v);
}
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__5025__auto__ = headers;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
