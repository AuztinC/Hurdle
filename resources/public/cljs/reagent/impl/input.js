...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__12667){
var map__12668 = p__12667;
var map__12668__$1 = cljs.core.__destructure_map.call(null,map__12668);
var on_write = cljs.core.get.call(null,map__12668__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5025__auto__ = (!((((node === document.activeElement)) && (((reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5025__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__12690 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__12691 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__12691);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__12690);
}}));
} else {
...
if(cljs.core.truth_((function (){var and__5023__auto__ = (!((jsprops == null)));
if(and__5023__auto__){
var and__5023__auto____$1 = jsprops.hasOwnProperty("onChange");
...
}):(cljs.core.truth_((function (){var and__5023__auto__ = original_ref_fn;
...
(jsprops.onChange = (function (p1__12750_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__12750_SHARP_);
}));
