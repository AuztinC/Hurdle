...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__14105 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__14104_SHARP_){
return cljs.core.subs.call(null,p1__14104_SHARP_,(0),(3));
}),G__14105);
} else {
return G__14105;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__14124){
var vec__14125 = p__14124;
var t = cljs.core.nth.call(null,vec__14125,(0),null);
var pattern = cljs.core.nth.call(null,vec__14125,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__14128 = pattern;
switch (G__14128) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14128)].join('')));
...
return p1__14129_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__14130_SHARP_){
return p1__14130_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__14131_SHARP_){
return p1__14131_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__14132_SHARP_){
return p1__14132_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__14133_SHARP_){
return p1__14133_SHARP_.getHours();
});

break;
case "day":
return (function (p1__14134_SHARP_){
return p1__14134_SHARP_.getDate();
});

break;
case "month":
return (function (p1__14135_SHARP_){
return p1__14135_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__14136_SHARP_){
return p1__14136_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14137__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__14143){
...
var key = first__14146;
var args = seq__14145__$1;
var G__14147 = key;
...
break;
case "ordinal-suffix":
var vec__14149 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__14149,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14147__$1)].join('')));
...
var d = value;
var G__14155 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__14156 = G__14155;
var seq__14157 = cljs.core.seq.call(null,vec__14156);
var first__14158 = cljs.core.first.call(null,seq__14157);
var seq__14157__$1 = cljs.core.next.call(null,seq__14157);
var unparser = first__14158;
var more = seq__14157__$1;
var s = "";
var d__$1 = d;
var G__14155__$1 = G__14155;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__14168 = G__14155__$1;
var seq__14169 = cljs.core.seq.call(null,vec__14168);
var first__14170 = cljs.core.first.call(null,seq__14169);
var seq__14169__$1 = cljs.core.next.call(null,seq__14169);
var unparser__$1 = first__14170;
var more__$1 = seq__14169__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__14175 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__14175,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__14175,(1),null);
var G__14179 = d__$3;
var G__14180 = more__$1;
var G__14181 = s__$3;
d__$1 = G__14179;
G__14155__$1 = G__14180;
s__$1 = G__14181;
continue;
}
break;
